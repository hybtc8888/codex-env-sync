---
name: crawl4ai
description: Use when users need to crawl websites with Crawl4AI, extract Markdown or structured data, handle JavaScript-heavy pages, process multiple URLs, or build web data pipelines.
version: 0.7.4
...
> Compatibility note: This skill was written for Crawl4AI 0.7.4. On Crawl4AI
> 0.8.x, verify signatures before reusing advanced examples. Prefer
> `LLMConfig` for LLM extraction and a dispatcher for concurrency controls.
